    ...
    <div class="content has-text-centered" id="flow">
      ...
      <p class="buttons">
          <router-link to="/flow/ssl/SslNbY" class="button is-light">
            ...
            <span><strong>Yes</strong>. The error is still present. </span>
          </router-link>  
          <router-link to="/flow/ssl/SslNbN" class="button is-light">
            <span class="icon has-text-danger">
              <i class="fas fa-exclamation-circle"></i>
            </span>
            <span><strong>No</strong>. The website now loads.</span>
          </router-link>
        </p>

        <!-- BEGIN - Back button -->
        <p class="buttons">
          <router-link to="/flow/ssl/SslN" class="button is-small is-info">
