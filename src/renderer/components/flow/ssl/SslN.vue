  ...
  <div id="flow-deck">
    ...
    <div class="content has-text-centered" id="flow">
      <div class="content is-medium">
        <p>Is this a <strong>Managed Wordpress</strong> based website?</p>
      </div>
      <p class="buttons">
          <router-link to="/flow/ssl/SslNa" class="button is-light">
            <span class="icon has-text-success">
              <i class="fas fa-check-circle"></i>
            </span>
            <span><strong>Yes</strong>. It is Managed Wordpress based</span>
          </router-link>  
          <router-link to="/flow/ssl/SslNb" class="button is-light">
            <span class="icon has-text-danger">
              <i class="fas fa-exclamation-circle"></i>
            </span>
            <span><strong>No</strong>. It is not Managed Wordpress based</span>
          </router-link>
        </p>
      
        <!-- BEGIN - Back button -->
        <p class="buttons">
          <router-link to="/flow/sslError" class="button is-small is-info">
