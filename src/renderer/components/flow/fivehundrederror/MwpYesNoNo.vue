...
<div id="flow-deck-two">
    ...
    <div class="content has-text-centered" id="flow">
      ...
      <p>Enable Debug Mode. Does it call out specific plugin or theme issues?</p>
      <p class="buttons">
          <router-link to="/flow/fivehundrederror/MwpYesFinal" class="button is-light">
            <span class="icon has-text-success">
              <i class="fas fa-check-circle"></i>
            </span>
            <span><strong>Yes</strong>. There are errors.</span>
          </router-link>  
          <router-link to="/flow/fivehundrederror/MwpNoFinal" class="button is-light">
            <span class="icon has-text-danger">
              <i class="fas fa-exclamation-circle"></i>
            </span>
            <span><strong>No</strong>. There are no errors.</span>
          </router-link>
        </p>
      </div> 
      <!-- END - Primary application deck -->
      	  <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/fivehundrederror/MwpYesNo" class="button is-small is-info">
