    ...
    <div class="content has-text-centered" id="flow">    
      ...
      <article class="message is-small is-success">
        <div class="message-body">
          Sell <strong><a href="https://www.godaddy.com/web-security/website-security" target="_blank">WSS (Website Security)</a></strong>. Customer needs to address the malicious files in their website.
        </div>
        <br>
        <div class="message-body">
