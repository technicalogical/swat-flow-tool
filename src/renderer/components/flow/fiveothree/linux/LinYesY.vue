  ...
  <div id="flow-deck">
    ...
    <div class="content has-text-centered" id="flow">
      <div class="content is-medium">
        <p>Check concurrent connections and usage data. Are <strong>cPanel</strong> resources spiking?</p>
      </div>
      <p class="buttons">
          ...
          <router-link to="/flow/fiveothree/linux/LinYesYno" class="button is-light">
      	  ...
      	  <!-- BEGIN - Back button -->
      <p class="buttons">
        <router-link to="/flow/fiveothree/linux/LinYes" class="button is-small is-info">
